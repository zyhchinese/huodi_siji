package com.lxwls.hdsjd.update;
...
import com.lxwls.hdsjd.utils.StreamUtil;
...
public class DownloadService extends Service {
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.lxwls.hdsjd.provider", file);
