...
public class CommonButton extends View {
    ...
    private static final String TAG = CommonButton.class.getSimpleName();
    ...
    public CommonButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShadowColor = attributes.getColor(
                R.styleable.PaperButton_paper_shadow_color, getResources()
                        .getColor(R.color.paper_button_shadow_color));
        ...
        mTextSize = attributes.getDimensionPixelSize(
                R.styleable.PaperButton_paper_text_size, getResources()
                        .getDimensionPixelSize(R.dimen.paper_text_size));
        mTextColor = attributes.getColor(
                R.styleable.PaperButton_paper_text_color, getResources()
                        .getColor(R.color.paper_text_color));
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (!mFingerRect.contains(getLeft() + (int) event.getX(), getTop()
                        + (int) event.getY())) {
                    mMoveOutside = true;
                    mState = StateNormal;
                    invalidate();
