...
public class SuYun_XiaoJianDan_EWaiXuQiuAdapter extends RecyclerView.Adapter<SuYun_XiaoJianDan_EWaiXuQiuAdapter.ViewHolder> {

    private Context context;
    private List<SuYun_XiaoJianDan_EWaiXuQiu> eWaiEntityList;
    private int a;
    public SuYun_XiaoJianDan_EWaiXuQiuAdapter(Context context, List<SuYun_XiaoJianDan_EWaiXuQiu> eWaiEntityList, int a) {
