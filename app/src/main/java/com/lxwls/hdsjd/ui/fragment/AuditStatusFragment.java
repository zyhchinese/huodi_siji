...
import com.lxwls.hdsjd.adapter.RecyclerAuditAdapter;
...
import com.lxwls.hdsjd.ui.activity.SuYunDan_BanJiaDan_XiangQingActivity;
import com.lxwls.hdsjd.ui.activity.SuYunDan_XiaoJianDan_XiangQingActivity;
    ...
    private void initRecyclerView() {
        ...
        adapter.setOnClickChild(new RecyclerAuditAdapter.OnClickChild() {
            ...
            public void onClick(int position) {
                ...
                if (type == 0) {
                    Intent intent = new Intent(getContext(), SuYunDan_XiaoJianDan_XiangQingActivity.class);
                    intent.putExtra("orderno", auditOrderEntityList.get(position).getOrderno());
                    intent.putExtra("line", "1");
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getContext(), SuYunDan_BanJiaDan_XiangQingActivity.class);
