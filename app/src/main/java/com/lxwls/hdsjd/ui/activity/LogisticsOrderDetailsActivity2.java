...
import com.lxwls.hdsjd.bean.LogisticsOrderDetailsEntity2;
...
//        tv_yuji_daoda.setText(detailsEntityList.get(0).getExpectedarrivaltime());
        ...
        if (detailsEntityList.get(0).getWeight()==0){
            tv_huowuzhongliang.setText(detailsEntityList.get(0).getVolume()+"方");
        }else if (detailsEntityList.get(0).getVolume()==0){
            tv_huowuzhongliang.setText(detailsEntityList.get(0).getWeight()+"吨");

        }else {
            tv_huowuzhongliang.setText(detailsEntityList.get(0).getWeight()+"吨/"+detailsEntityList.get(0).getVolume()+"方");
        }
