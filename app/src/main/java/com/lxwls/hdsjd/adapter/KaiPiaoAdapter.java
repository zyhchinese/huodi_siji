...
import com.lxwls.hdsjd.ui.activity.KaiPiaoActivity1Activity;
...
public class KaiPiaoAdapter extends RecyclerView.Adapter<KaiPiaoAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(final KaiPiaoAdapter.ViewHolder viewHolder, final int i) {
        viewHolder.tv_conent1.setText(list.get(i).getStartaddress());
        viewHolder.tv_conent2.setText(list.get(i).getEndaddress());
