...
import com.lxwls.hdsjd.adapter.SuYun_XiaoJianDan_EWaiXuQiuAdapter;
...
import com.lxwls.hdsjd.bean.SuYun_XiaoJianDan_XiangQing;
...
/**
 * Created by admin on 2018/3/14.（首页-速运-小件单详情）
 */
public class SuYun_XiaoJianDan_XiangQiangAvtivity extends BackCommonActivity implements View.OnClickListener{

    private TextView tv_fhr,tv_address,tv_address1,tv_qidianjuli,tv_zhongliang,tv_quhuotime,
            tv_yujishijian,tv_dingdanshijian,tv_money,tv_qiangdan,tv_beizhu,tv_fhr111,tv_fangshi;
    ...
    private List<SuYun_XiaoJianDan_XiangQing> detailsEntityList;
    ...
    protected int getContentView() {
        return R.layout.shouye_suyun_xiaojiandan_xiangqing;
    }
    @Override
    protected void initWidget() {
        ...
        tv_quhuotime = (TextView) findViewById(R.id.tv_quhuotime);//取货时间
        tv_yujishijian  = (TextView) findViewById(R.id.tv_yujishijian);//预计到达时间
        ...
        tv_quhuotime.setOnClickListener(this);
        tv_yujishijian.setOnClickListener(this);
    ...
    //获取信息并添加头像
    private void updateUserInfo(SuYun_XiaoJianDan_XiangQing detailsEntityList) {
        if (detailsEntityList != null) {
            tv_fhr.setText(detailsEntityList.getFname());
            tv_fhr111.setText(detailsEntityList.getConsigneename());
            tv_address.setText(detailsEntityList.getStartaddress());
            tv_address1.setText(detailsEntityList.getEndaddress());
            tv_qidianjuli.setText(juli + "公里");//起点距离
            tv_zhongliang.setText(detailsEntityList.getWeightofgoods());
            tv_quhuotime.setText(detailsEntityList.getPickuptime());
            tv_yujishijian.setText(detailsEntityList.getExpectedarrivaltime());
            ...
            tv_qiangdan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    map.put("id", SuYun_XiaoJianDan_XiangQiangAvtivity.this.detailsEntityList.get(0).getId() + "");
                    map.put("ordertype","1");
                    Gson gson = new Gson();
                                ...
                                public void onNext(@NonNull ResponseBody responseBody) {
                                    ...
                                    try {
                                        ...
                                        if (body.indexOf("berobbed") != -1) {
                                            ...
                                            payalertDialog = new AlertDialog.Builder(SuYun_XiaoJianDan_XiangQiangAvtivity.this).create();
                                            payalertDialog.show();
                                            ...
                                            payalertDialog.getWindow()
                                                    ...
                                                    .setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View v) {
                                                            ...
                                                            Intent intent1 = new Intent(SuYun_XiaoJianDan_XiangQiangAvtivity.this, SuYunDan_XiaoJianDan_LieBiaoActivity.class);
    ...
    private void initEWai() {
        ...
        Gson gson = new Gson();
        String params = gson.toJson(map);
        PileApi.instance.selectSuyunOrderDetailServ(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
...
//                                showToast("订单详情暂无数据");
    ...
    private void initEwaiRecyclerView() {
        SuYun_XiaoJianDan_EWaiXuQiuAdapter adapter = new SuYun_XiaoJianDan_EWaiXuQiuAdapter(this, eWaiEntityList,Integer.parseInt(detailsEntityList.get(0).getCust_orderstatus()));
    ...
    private void initOrderDetails() {
        ...
        PileApi.instance.selectSuyunOrderDetail1(data)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            if (body.indexOf("false") != -1 || body.length() < 6) {
                                ...
                                Gson gson = new Gson();
                                detailsEntityList = gson.fromJson(body, new TypeToken<List<SuYun_XiaoJianDan_XiangQing>>() {
                                }.getType());
    ...
    private void callPhone(String phoneNum) {
        ...
        if (call==1){
            ...
            consigneephone=detailsEntityList.get(0).getConsigneephone();
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_iphone111:
                String consigneephone11=detailsEntityList.get(0).getConsigneephone();
            ...
            case R.id.tv_pingjia:
                AlertDialog.Builder dialog11 = new AlertDialog.Builder(SuYun_XiaoJianDan_XiangQiangAvtivity.this);
                View view = LayoutInflater.from(SuYun_XiaoJianDan_XiangQiangAvtivity.this).inflate(R.layout.kuaiyun_qiangdanchenggong, null, false);
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            if (body.indexOf("false") != -1 || body.length() < 1) {
                                ...
                                showToast("订单取消成功");
                                final AlertDialog dialog = new AlertDialog.Builder(SuYun_XiaoJianDan_XiangQiangAvtivity.this).create();
                                dialog.setCancelable(false);
                                dialog.show();
                                ...
                                Toast.makeText(SuYun_XiaoJianDan_XiangQiangAvtivity.this, "111", Toast.LENGTH_SHORT).show();
                            }
                        } catch (IOException e) {
                        }
                    }
