...
//    Observable<ResponseBody> postBody(@Url String url, @Body RequestBody body);
    ...
    @POST("app/version?action=getVersionInfo&project=货滴司机")
    ...
    //快运提交接口
    @FormUrlEncoded
    @POST("mbtwz/logisticssendwz?action=addKuaiyunOrder")
   ...
   // 货主端 查询收费标准 接口
    ...
    //找货 货滴速运 同城小件单 列表
    @FormUrlEncoded
    @POST("mbtwz/find?action=selectSuyunOrderList")
    Observable<ResponseBody> selectSuyunOrderList(@Field("page") int page, @Field("rows") int rows, @Field("params") String params);
    ...
    //速运单 同城小件单 订单详情额外需求 查询接口
    @FormUrlEncoded
    @POST("mbtwz/find?action=selectSuyunOrderDetailServ")
    Observable<ResponseBody> selectSuyunOrderDetailServ(@Field("params") String params);


    //同城小件单  订单详情
    @FormUrlEncoded
    @POST("mbtwz/find?action=selectSuyunOrderDetail")
    Observable<ResponseBody> selectSuyunOrderDetail1(@Field("params") String params);



    //三种订单 抢单 接口
    @FormUrlEncoded
    @POST("mbtwz/find?action=updateGrabASingle")
    Observable<ResponseBody> updateGrabASingle(@Field("params") String params);


    //司机同城小件单  订单列表  查询接口
    @POST("mbtwz/logisticssendwz?action=searchfindSuyunorder")
    Observable<ResponseBody> searchfindSuyunorder();

    //司机搬家订单接口
    @POST("mbtwz/logisticssendwz?action=searchfindorder")
    Observable<ResponseBody> searchfindorder();


    //司机快运订单接口
    @POST("mbtwz/logisticssendwz?action=searchfindKuaiyunorder")
    Observable<ResponseBody> searchfindKuaiyunorder();


    //司机订单搜索
    @FormUrlEncoded
    @POST("mbtwz/find?action=searchOrderByParamSJ")
    Observable<ResponseBody> searchOrderByParamSJ(@Field("data") String data);


    //定位
    @FormUrlEncoded
    @POST("huodigps?action=saveGps")
    Observable<ResponseBody> saveGps(@Field("params") String params);


    //新增快运单抢单接口
    @FormUrlEncoded
    @POST("mbtwz/find?action=updateGrabASingle_ky")
    Observable<ResponseBody> updateGrabASingle_ky(@Field("params") String params);
