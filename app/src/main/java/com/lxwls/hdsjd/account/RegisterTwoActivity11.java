...
import com.lxwls.hdsjd.receiver.MyJPushMessageReceiver;
...
public class RegisterTwoActivity11 extends AccountBaseActivity {
    ...
    protected int getContentView() {
        return R.layout.activity_register_two11;
    }
                            ...
                            if (body.length() < 10) {
                                ...
                                try {
                                    ...
                                    if (AccountHelper.login(userList.get(0))) {
                                        ...
                                        myJPushMessageReceiver.onAliasOperatorResult(RegisterTwoActivity11.this, jPushMessage);

                                        JPushInterface.init(RegisterTwoActivity11.this);
                                        if (JPushInterface.isPushStopped(RegisterTwoActivity11.this)) {
                                            JPushInterface.resumePush(RegisterTwoActivity11.this);
                                        }
                                        JPushInterface.setAlias(RegisterTwoActivity11.this, userList.get(0).getId() + "", null);
