...
public class PileApi {
    ...
    //找货 货滴速运 同城小件单 列表
    public Observable<ResponseBody> selectSuyunOrderList(int page,int rows,String paraments) {
        return service.selectSuyunOrderList(page,rows,paraments);
    }
    ...
    //速运单 同城小件单 订单详情额外需求 查询接口
    public Observable<ResponseBody> selectSuyunOrderDetailServ(String params) {
        return service.selectSuyunOrderDetailServ(params);
    }

    //同城小件单  订单详情
    public Observable<ResponseBody> selectSuyunOrderDetail1(String params) {
        return service.selectSuyunOrderDetail1(params);
    }

    //三种订单 抢单 接口
    public Observable<ResponseBody> updateGrabASingle(String params) {
        return service.updateGrabASingle(params);
    }


    //司机同城小件单  订单列表  查询接口
    public Observable<ResponseBody> searchfindSuyunorder() {
        return service.searchfindSuyunorder();
    }

    //司机搬家订单接口
    public Observable<ResponseBody> searchfindorder() {
        return service.searchfindorder();
    }


    //司机快运订单接口
    public Observable<ResponseBody> searchfindKuaiyunorder() {
        return service.searchfindKuaiyunorder();
    }

    //司机订单搜索
    public Observable<ResponseBody> searchOrderByParamSJ(String data) {
        return service.searchOrderByParamSJ(data);
    }

    //定位
    public Observable<ResponseBody> saveGps(String paraments) {
        return service.saveGps(paraments);
    }


    //新增快运单抢单接口
    public Observable<ResponseBody> updateGrabASingle_ky(String params) {
        return service.updateGrabASingle_ky(params);
    }
