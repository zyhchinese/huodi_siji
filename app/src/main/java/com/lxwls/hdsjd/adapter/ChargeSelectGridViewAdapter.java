...
public class ChargeSelectGridViewAdapter extends BaseAdapter {
    ...
    public ChargeSelectGridViewAdapter(Context context, ArrayList<String> nameList) {
        mNameList = nameList;
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = mInflater.inflate(R.layout.item_gridview_charge, null);
