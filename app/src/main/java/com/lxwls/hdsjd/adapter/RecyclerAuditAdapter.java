...
//        String substring = list.get(position).getCreatetime().substring(0, 10);
        ...
        if (type==0){
            ...
            holder.tv_fhr.setText(list.get(position).getFname());
            ...
            if (list1.get(position).getDriver_orderstatus().equals("-1")){
                holder.tv_zhuangtai.setText("已取消");
            }else if (list1.get(position).getDriver_orderstatus().equals("0")){
                holder.tv_zhuangtai.setText("前往中");
            }else if (list1.get(position).getDriver_orderstatus().equals("1")){
                holder.tv_zhuangtai.setText("开始订单");
            }else if (list1.get(position).getDriver_orderstatus().equals("2")){
                holder.tv_zhuangtai.setText("已完成");
            }
            ...
            holder.tv_fhr.setText(list1.get(position).getFname());
