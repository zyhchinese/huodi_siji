package com.lxwls.hdsjd.base.fragment;
...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter {
    ...
    public static final int BOTH_HEADER_TWOFOOTER = 4;

    public static final int VIEW_TYPE_NORMAL = 0;
    public static final int VIEW_TYPE_HEADER = -1;
    public static final int VIEW_TYPE_FOOTER = -2;
    public static final int VIEW_TYPE_FOOTER1 = -3;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case VIEW_TYPE_FOOTER1:
                if (onLoadingFooterCallBack != null)
                    onLoadingFooterCallBack.onBindFooterHolder(holder, position);
                break;
            case VIEW_TYPE_FOOTER:
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (lp != null && lp instanceof StaggeredGridLayoutManager.LayoutParams) {
            ...
            }else if (BEHAVIOR_MODE == BOTH_HEADER_TWOFOOTER) {
                if (holder.getLayoutPosition() == 0 || holder.getLayoutPosition() == mItems.size() + 2) {
                    p.setFullSpan(true);
                }
            }
        }
    ...
    public int getItemViewType(int position) {
        if (position == 0 && (BEHAVIOR_MODE == ONLY_HEADER || BEHAVIOR_MODE == BOTH_HEADER_FOOTER|| BEHAVIOR_MODE == BOTH_HEADER_TWOFOOTER))
            return VIEW_TYPE_HEADER;
        if (position + 2 == getItemCount() && ( BEHAVIOR_MODE == BOTH_HEADER_TWOFOOTER))
            return VIEW_TYPE_FOOTER1;
        if (position + 1 == getItemCount() && (BEHAVIOR_MODE == ONLY_FOOTER || BEHAVIOR_MODE == BOTH_HEADER_FOOTER|| BEHAVIOR_MODE == BOTH_HEADER_TWOFOOTER))
...
//
        return BEHAVIOR_MODE == ONLY_HEADER || BEHAVIOR_MODE == BOTH_HEADER_FOOTER || BEHAVIOR_MODE == BOTH_HEADER_TWOFOOTER? position - 1 : position;
