...
import com.lxwls.hdsjd.widgets.MyWebViewClient;
...
public class ActivedetailsActivity extends BackCommonActivity {
    private WebView webView;
    private TextView tvTitle;
    private ImageView img_fenxiang;
    private activebean primaryNew;
    public static final String KEY_BUNDLE = "KEY_BUNDLE_IN_ORDERD_ETIAL";

    public static void show(Context context, activebean primaryNews) {
    ...
    protected boolean initBundle(Bundle bundle) {
        primaryNew = (activebean) bundle.getSerializable(KEY_BUNDLE);
        if (primaryNew == null || (Integer.valueOf(primaryNew.getId()) <= 0)) {
            showToast("资讯不存在");
            return false;
        }
    ...
    protected void initWidget() {
        ...
        img_fenxiang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OthreShare.showShare(ActivedetailsActivity.this,primaryNew.getActivityname(),"", "http://www.huodiwulian.com/logo_sj.png","http://www.huodiwulian.com/hdsywz/page/xinwen/xinwenxiangqingm.html?id="+primaryNew.getId()+"&type=2");
            }
        });
        ...
        //设置WebViewClient
        webView.setWebViewClient(new MyWebViewClient(ActivedetailsActivity.this));
        //设置WebChromeClient
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message,
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ActivedetailsActivity.this);
...
//        PileApi.instance.getActivityDetail(params)
