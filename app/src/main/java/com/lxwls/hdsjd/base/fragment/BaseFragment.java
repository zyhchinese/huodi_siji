...
import com.lxwls.hdsjd.utils.ImageLoaders;
...
public abstract class BaseFragment extends Fragment {
    ...
    protected void setImageFromNet(ImageView imageView, String imageUrl, int placeholder) {
        ImageLoaders.loadImage(getImgLoader(), imageView, imageUrl, placeholder);
    }
    ...
    public ProgressDialog showWaitDialog(String message) {
        if (mDialog == null) {
            mDialog = DialogHelper.getProgressDialog(mContext, message);
        }
    ...
    public void showToast(String message) {
        ...
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.view_toast, null, false);
