...
/**
 * Created by admin on 2018/3/15.（速运-小件单-订单详情）
 */
public class SuYunDan_XiaoJianDan_XiangQingActivity extends BackCommonActivity implements View.OnClickListener{

    private TextView tv_diandanhao,tv_fhr,tv_address,tv_address1,tv_qidianjuli,tv_quhuotime,tv_zhongliang,
            tv_yujishijian,tv_dingdanshijian,tv_money,tv_beizhu,tv_zhuangtai,tv_pingjia,tv_fhr111,tv_fangshi;
    ...
    protected int getContentView() {
        return R.layout.suyun_xiaojiandan_dingdanxiangqing1;
    }
    @Override
    protected void initWidget() {
        ...
        tv_pingjia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder dialog11 = new AlertDialog.Builder(SuYunDan_XiaoJianDan_XiangQingActivity.this);
                View view = LayoutInflater.from(SuYunDan_XiaoJianDan_XiangQingActivity.this).inflate(R.layout.dialog_pingjiadingdan, null, false);
                ...
                tagFlow.setAdapter(new TagAdapter<String>(pingyulist) {
                    ...
                    public View getView(FlowLayout parent, int position, String s) {
                        TextView tv_name= (TextView) LayoutInflater.from(SuYunDan_XiaoJianDan_XiangQingActivity.this).inflate(R.layout.pingyu_item,tagFlow,false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_iphone111:
                String consigneephone111=detailsEntityList.get(0).getConsigneephone();
                AlertDialog.Builder builder1122=new AlertDialog.Builder(this)
                        .setTitle("提示")
                        .setMessage("确定拨打电话："+consigneephone111)
                        .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
...
//                AlertDialog.Builder dialog11 = new AlertDialog.Builder(SuYunDan_XiaoJianDan_XiangQingActivity.this);
//                View view = LayoutInflater.from(SuYunDan_XiaoJianDan_XiangQingActivity.this).inflate(R.layout.kuaiyun_qiangdanchenggong, null, false);
//                dialog11.setView(view);
//                final AlertDialog alertDialog = dialog11.create();
//                alertDialog.setCancelable(false);
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            if (body.indexOf("false") != -1 || body.length() < 1) {
                                ...
                                showToast("订单取消成功");
                                final AlertDialog dialog = new AlertDialog.Builder(SuYunDan_XiaoJianDan_XiangQingActivity.this).create();
                                dialog.setCancelable(false);
                                dialog.show();
                                ...
                                Toast.makeText(SuYunDan_XiaoJianDan_XiangQingActivity.this, "111", Toast.LENGTH_SHORT).show();
                            }
                        } catch (IOException e) {
                        }
                    }
