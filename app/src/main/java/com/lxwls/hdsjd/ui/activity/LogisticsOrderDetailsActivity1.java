...
import com.lxwls.hdsjd.bean.LogisticsOrderDetailsEntity1;
...
public class LogisticsOrderDetailsActivity1 extends BackCommonActivity implements View.OnClickListener {
    ...
    private TextView tv_xingming,tv_lianxi,tv_yongche11,tv_yongcheshijian11,tv_dingdan11,
            tv_xuqiu11,tv111,tv222,tv333,tv444,tv_zongji,tv_danwei,tv_yuan;
    ...
    protected void initWidget() {
        ...
        tv_yongche11 = (TextView) findViewById(R.id.tv_yongche11);
        tv_yongcheshijian11 = (TextView) findViewById(R.id.tv_yongcheshijian11);
...
//                                showToast("订单详情暂无数据");
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            if (body.indexOf("false") != -1 || body.length() < 6) {
                                ...
                                Gson gson = new Gson();
                                detailsEntityList = gson.fromJson(body, new TypeToken<List<LogisticsOrderDetailsEntity1>>() {
                                }.getType());
                                //加载额外需求信息
                                initEWai();
    ...
    private void initFuZhi() {
        tv_dingdanhao.setText(detailsEntityList.get(0).getOwner_orderno());
        if (detailsEntityList.get(0).getCust_orderstatus() == -1) {
            ...
            tv_yongche11.setTextColor(Color.parseColor("#B9B9B9"));
            tv_car_type.setTextColor(Color.parseColor("#B9B9B9"));
            tv_yongcheshijian11.setTextColor(Color.parseColor("#B9B9B9"));
            ...
            tv_juli.setTextColor(Color.parseColor("#B9B9B9"));
            tv_danwei.setTextColor(Color.parseColor("#B9B9B9"));
        ...
        tv_name.setText(detailsEntityList.get(0).getOwner_link_name());
        tv_phone.setText(detailsEntityList.get(0).getOwner_link_phone());
        tv_car_type.setText(detailsEntityList.get(0).getCar_type());
        tv_yongchetime.setText(detailsEntityList.get(0).getOwner_sendtime());
//        tv_yuji_daoda.setText(detailsEntityList.get(0).getExpectedarrivaltime());
        tv_dingdantime.setText(detailsEntityList.get(0).getOwner_createtime());
        tv_address.setText(detailsEntityList.get(0).getOwner_address());
        tv_address1.setText(detailsEntityList.get(0).getOwner_send_address());
        if (detailsEntityList.get(0).getOwner_note().equals("")){
            relative.setVisibility(View.GONE);
        }else {
            relative.setVisibility(View.VISIBLE);
            tv_beizhu.setText(detailsEntityList.get(0).getOwner_note());
        }
        tv_juli.setText(detailsEntityList.get(0).getTotal_mileage()+"");
        tv_money.setText(detailsEntityList.get(0).getOwner_totalprice()+"");
...
//        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_pingjia:
                AlertDialog.Builder dialog11 = new AlertDialog.Builder(LogisticsOrderDetailsActivity1.this);
                View view = LayoutInflater.from(LogisticsOrderDetailsActivity1.this).inflate(R.layout.dialog_pingjiadingdan, null, false);
    ...
    private void initKaishi() {
        ...
        Gson gson = new Gson();
        String data = gson.toJson(map);
        PileApi.instance.startOrder(data)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
...
//        map.put("siji_findtime", detailsEntityList.get(0).getSiji_findtime());
        ...
        Gson gson = new Gson();
        String data = gson.toJson(map);
        PileApi.instance.finishOrderfinishOrder(data)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
...
//        map.put("owner_createtime", detailsEntityList.get(0).getOwner_createtime());
        ...
        Gson gson = new Gson();
        String data = gson.toJson(map);
        PileApi.instance.cancelOrder(data)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            if (body.indexOf("false") != -1 || body.length() < 1) {
                                ...
                                showToast("订单取消成功");
                                final AlertDialog dialog = new AlertDialog.Builder(LogisticsOrderDetailsActivity1.this).create();
                                dialog.setCancelable(false);
                                dialog.show();
...
//                                initOrderDetails();
                                ...
                                Toast.makeText(LogisticsOrderDetailsActivity1.this, "111", Toast.LENGTH_SHORT).show();
                            }
                        } catch (IOException e) {
                        }
                    }
