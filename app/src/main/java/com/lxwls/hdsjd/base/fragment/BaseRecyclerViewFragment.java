...
import com.lxwls.hdsjd.refresh.EmptyLayout;
import com.lxwls.hdsjd.refresh.RecyclerRefreshLayout;
import com.lxwls.hdsjd.utils.CacheManager;
...
public abstract class BaseRecyclerViewFragment<T> extends BaseFragment implements
    ...
    protected Observer<List<T>> mHandler;
    ...
    public void initData() {
        ...
        mHandler=new Observer<List<T>>() {
                    ...
                    @Override
                    public void onNext(@NonNull List<T> tPageBean) {
                        try {
                            List<T> resultBean = tPageBean;
                            if (resultBean != null) {
