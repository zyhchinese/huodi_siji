...
public class ProvinceAdapter222 extends RecyclerView.Adapter<ProvinceAdapter222.ViewHolder>{
    ...
    public ProvinceAdapter222(Context context, List<ProvinceEntity> provinceEntityList) {
    ...
    @Override
    public ProvinceAdapter222.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ProvinceAdapter222.ViewHolder holder, final int position) {
