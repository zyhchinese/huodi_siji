package com.lxwls.hdsjd.widgets;
...
public class WaveProgressView extends View {
     ...
     * 默认波长
     */
    private static final int DEFAULT_RADIUS = 140;
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        mTextColor = ta.getColor(R.styleable.WaveProgressView_textColor, Color.parseColor("#FFFFFF"));
        mWaveColor = ta.getColor(R.styleable.WaveProgressView_waveColor, Color.parseColor("#8fc320"));
        mBorderColor = ta.getColor(R.styleable.WaveProgressView_borderColor, Color.parseColor("#FFFFFF"));
        ...
        mProgress = ta.getInteger(R.styleable.WaveProgressView_progress1, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String progress = mProgressText + "°";
        if (isHideProgressText) {
            progress = "";
        }
        mTextPaint.getTextBounds(progress, 0, progress.length(), mTextRect);
        canvas.drawText(progress, mRadius - mTextRect.width() / 2 + 20,
     ...
     * 设置显示的数字
     */
    public void setMProgressText(
            String mProgressText1)

    {
        mProgressText = mProgressText1;
    }
